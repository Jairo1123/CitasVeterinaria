...
$registro ->nuevaContraseñaController();
?>
<!DOCTYPE html>
<html lang="es">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Contraseña Nueva</h3>
                                        <br/>
                                        <h6 class="text-center txt-primary">Revisa tu correo electrónico para obtener el codigo de verificación.</h6>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            ...
                                            <label class="float-label">Codigo de verificación</label>
                                        </div>
                                </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Registar contraseña</button>
